...
class RoomClient {
    ...
    constructor(
        // localMediaEl, 
        // remoteVideoEl, 
        remoteAudioEl, mediasoupClient, socket, room_id, name, successCallback) {
        this.name = name
    ...
    initSockets() {
        ...
        this.socket.on('newProducers', async function (data) {
            ...
            for (let {
                ...
                await this.consume(producer_id, name)
            }
        }.bind(this))
    ...
    async consume(producer_id, producer_name) {
        ...
        this.getConsumeStream(producer_id).then(function ({
            ...
            if (kind === 'video') {
                ...
                elemDiv.id = "consumer_" + consumer.id
                elemName = document.createElement('span')
                elemName.innerHTML = producer_name
                ...
                this.remoteAudioEl.appendChild(elemDiv)
            }
    ...
    removeConsumer(consumer_id) {
        ...
        let elemDiv = document.getElementById("consumer_" + consumer_id)
